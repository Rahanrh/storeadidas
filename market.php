...
?>
  ...
  <body id="home">
    ...
    <div class="container">
      <a href="tambah_barang.php" class="btn btn-success mt-3">TAMBAH PRODAK BARANG</a>
      <div class="row">
          ...
          <div class="col-md-3 mt-4">
            <div class="card brder-dark">
              ...
              <div class="card-body">
                ...
                <a href="edit_barang.php?id_barang=<?php echo $result['id_barang']  ?>" class="btn btn-success btn-sm ">EDIT</a>

                <a href="hapus_barang.php?id_barang=<?php echo $result['id_barang']  ?>" class="btn btn-danger btn-sm  text-light">HAPUS</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
